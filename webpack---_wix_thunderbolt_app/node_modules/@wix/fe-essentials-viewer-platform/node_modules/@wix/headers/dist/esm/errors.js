...
var WixHeadersParsingError = /** @class */ (function(_super) {
    ...
    function WixHeadersParsingError(header, value) {
        return _super.call(this, "WixHeadersParsingError: ".concat(header, " evaluated with ").concat(JSON.stringify(value), " but should be a string!")) || this;
    }
...
var WixHeadersValidationError = /** @class */ (function(_super) {
    ...
    function WixHeadersValidationError(type, key, value) {
        return _super.call(this, "WixHeadersValidationError: expected ".concat(key, " to be ").concat(type, " but got ").concat(JSON.stringify(value))) || this;
    }
