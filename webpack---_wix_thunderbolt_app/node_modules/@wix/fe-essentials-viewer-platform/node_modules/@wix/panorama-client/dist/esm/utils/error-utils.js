...
const extractWixHttpErrorDetailsRec = error => {
    var _httpClientError$resp, _httpClientError$resp2, _httpClientError$resp3;
    ...
    return defaults(res, {
        ...
        requestId: (_httpClientError$resp = (_httpClientError$resp2 = httpClientError.response) == null ? void 0 : (_httpClientError$resp3 = _httpClientError$resp2.headers) == null ? void 0 : _httpClientError$resp3['x-wix-request-id']) != null ? _httpClientError$resp : httpClientError.requestId
    });
};
