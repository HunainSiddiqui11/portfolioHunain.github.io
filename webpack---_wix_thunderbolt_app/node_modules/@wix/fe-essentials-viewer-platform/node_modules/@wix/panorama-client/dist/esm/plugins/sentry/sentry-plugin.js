...
const initHooks = (hubResult, options) => {
    ...
    sentryBeforeSend((event, hint) => {
        ...
        const stackTraceArtifactsData = extractArtifactsDataFromSentryEvent(event);
    ...
    hooksManager.tap(Hook.beforeReportError, (error, data, errorMonitorOptions) => {
        ...
        if (errorMonitorOptions != null && (_errorMonitorOptions$ = errorMonitorOptions.pluginParams) != null && _errorMonitorOptions$.sentryLookupDsn) {
            var _errorMonitorOptions$2;
            const hub = getHubForDsn(errorMonitorOptions == null ? void 0 : (_errorMonitorOptions$2 = errorMonitorOptions.pluginParams) == null ? void 0 : _errorMonitorOptions$2.sentryLookupDsn, globalConfig);
            if (hub) {
                sentryHub = hub;
            }
        }
        ...
        sentryHub.withScope(scope => {
            attachPanoramaDataToSentryScope(scope, data);
    ...
    hooksManager.tap(Hook.beforeAddBreadcrumb, breadcrumb => {
        ...
        hub == null ? void 0 : hub.addBreadcrumb(breadcrumb);
    });
};
