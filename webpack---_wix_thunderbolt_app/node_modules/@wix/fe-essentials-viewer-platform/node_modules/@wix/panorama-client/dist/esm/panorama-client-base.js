...
export class BasePanoramaClient {
    constructor(_ref) {
        ...
        _defineProperty(this, "durationTracker", new DurationTracker());
    ...
    reportTransactionStart(name, data) {
        ...
        this.durationTracker.markTransactionStart(name);
    ...
    reportTransactionFinish(name, data) {
        ...
        const duration = this.durationTracker.markTransactionFinish(name);
        const payload = buildTransactionPayload(this.globalConfig, this.baseParams, {
            transactionName: name,
