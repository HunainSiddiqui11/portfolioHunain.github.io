...
export var PHASES_WHITE_LIST = {
    script_loaded: [22, 28],
    await_controller_promise: [22, 28]
};
export var SAMPLED_APP_NAMES = Object.keys(VERTICALS_LIST);
export var NON_SAMPLED_PHASES = Object.keys(PHASES_WHITE_LIST);