...
import {
    SampleRateManager
} from './sample-rate/sample-rate-manager';
...
var BaseLogger = /*#__PURE__*/ function() {
    function BaseLogger(appName, appVersion, reporter, params) {
        ...
        } // Cover for cases where the provided is_rollout value is undefined (as in case of TB)
    ...
    } // deprecating this method, making it a noop
    ;
    ...
    _proto._getDataItemWithDefaultParamsOverrides = function _getDataItemWithDefaultParamsOverrides(_temp7) {
        var _ref14 = _temp7 === void 0 ? {} : _temp7,
            _ref14$appName = _ref14.appName,
            appName = _ref14$appName === void 0 ? null : _ref14$appName;
    ...
    _proto.interactionStarted = function interactionStarted(interactionName, _temp8) {
        ...
        var _ref15 = _temp8 === void 0 ? {} : _temp8,
            ...
            interactionTimeout = _ref15.interactionTimeout,
            startHook = _ref15.startHook,
            timeoutHook = _ref15.timeoutHook,
        ...
        var scheduleTimeoutEvent = function scheduleTimeoutEvent() {
            if (interactionTimeout || _this.interactionTimeout) {
                return setTimeout(function() {
                    var dataSource = _this.dataSource.addItem({
                        interactionName: interactionName
                    }).addItem({
                        errorType: 'timeout'
                    }).addItem(_this.dataItems.biError());

                    _this._reportIfNotSSR(dataSource);
    ...
    _proto.interactionEnded = function interactionEnded(interactionName, _temp9) {
        var _ref16 = _temp9 === void 0 ? {} : _temp9,
            timeOverride = _ref16.timeOverride,
            timeoutId = _ref16.timeoutId,
            endHook = _ref16.endHook,
            customParams = _ref16.customParams,
    ...
    _proto._handleBlackboxPerformance = function _handleBlackboxPerformance() {
        ...
        if (actualEnv.addEventListener) {
            actualEnv.addEventListener(BLACKBOX, function(_ref17) {
    ...
    _proto._handleBlackboxPerformanceEntries = function _handleBlackboxPerformanceEntries(actualEnv, measurements) {
        ...
        measurements.filter(function(_ref18) {
            var then = _ref18.then;
            return then;
                ...
                switch (performanceEntry.entryType) {
                    ...
                    case 'responsiveness':
                        if (performanceEntry.eventName && actualEnv.addEventListener) {
                            actualEnv.addEventListener(performanceEntry.eventName, function(_ref19) {
    ...
    _proto.getLoggerForWidget = function getLoggerForWidget(_ref20) {
        var appName = _ref20.appName,
            appId = _ref20.appId,
            widgetId = _ref20.widgetId,
            version = _ref20.version,
            timeoutHook = _ref20.timeoutHook,
            startHook = _ref20.startHook,
            endHook = _ref20.endHook,
            useGlobalLogger = _ref20.useGlobalLogger,
            paramsOverrides = _ref20.paramsOverrides,
            phasesConfig = _ref20.phasesConfig;
    ...
    _proto._reportWebVitalsWhenAvailable = function _reportWebVitalsWhenAvailable() {
        ...
        Promise.all([this._webVitalsLoadedPromise, this._platformTenantsPromise]).then(function(_ref22) {
            var webVitalsLoaded = _ref22[0],
        ...
        Promise.all([this._webVitalsFirstInputPromise, this._platformTenantsPromise]).then(function(_ref23) {
            var webVitalsFirstInput = _ref23[0],
                platformTenantAppNames = _ref23[1];
