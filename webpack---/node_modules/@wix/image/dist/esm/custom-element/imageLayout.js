...
function measure(id, measures, domNodes, {
    ...
    const {
        width,
        height
    } = ((_b = services.getMediaDimensionsByEffect) === null || _b === void 0 ? void 0 : _b.call(services, bgEffectName, sourceOfDimensions.offsetWidth, sourceOfDimensions.offsetHeight, screenHeight)) || {
