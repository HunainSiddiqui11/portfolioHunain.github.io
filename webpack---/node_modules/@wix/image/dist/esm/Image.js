...
const Image = (props) => {
    ...
    React.useEffect(() => {
        ...
        if (onLoad && (imgElment === null || imgElment === void 0 ? void 0 : imgElment.currentSrc) && (imgElment === null || imgElment === void 0 ? void 0 : imgElment.complete)) {
            onLoad({
    ...
    const maxWidth = ssrResult && !(ssrResult === null || ssrResult === void 0 ? void 0 : ssrResult.transformed) ?
        `max(${width}px, 100%)` :
        targetWidth ?
        `${targetWidth}px` :
        null;
