...
const TIMEOUT = 2000;
const generateUrl = (staticsUrl, language) => staticsUrl.replace(/\/$/, '') + "/assets/locale/messages_" + language + ".json";
export const loadTranslations = (staticsUrl, language, callback) => {
    if (language === 'en') {
