...
function getStaticsUrl() {
    ...
    const staticsRoot = 'https://static.parastorage.com/services/cookie-consent-banner-for-uou/';
    let staticsUrl = '';
    if (_window.staticsBaseUrl) {
        staticsUrl = _window.staticsBaseUrl;
    }
    if (_window.wixTagManager && typeof _window.wixTagManager.getConfig === 'function') {
        var _window$wixTagManager;
        staticsUrl = (_window$wixTagManager = _window.wixTagManager.getConfig()) == null ? void 0 : _window$wixTagManager.wixBannerStatics;
    }
    if (!staticsUrl) {
...
export async function openSettingModal() {
    ...
    const locale = ((_window$wixEmbedsAPI = window.wixEmbedsAPI) == null ? void 0 : _window$wixEmbedsAPI.getLanguage()) || 'en';
