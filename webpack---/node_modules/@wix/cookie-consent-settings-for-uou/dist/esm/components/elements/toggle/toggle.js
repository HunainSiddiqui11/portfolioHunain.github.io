...
export const Toggle = props => {
    ...
    function updateContainerClassName() {
        const inputFocused = document.activeElement === input && document.hasFocus();
        container.className = css.toggle + " " + props.className + " " + (inputFocused ? css.focus : '');
    }
    const input = Input({
        className: css.input,
        type: 'checkbox',
