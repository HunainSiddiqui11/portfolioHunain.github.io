...
import {
    savePolicy
} from '../../services/consent-policy-manager/consent-policy-manager';
import {
    translationKeys
} from '../../constants/constants';
import {
    logger
} from '../../services/bi-logger/bi-logger-service';
export class SettingsComponent extends BaseComponent {
    constructor(props) {
        ...
        _defineProperty(this, "onSaveClicked", () => {
            logger.onSettingsChanged(JSON.stringify(this.state.startConsentPolicy), JSON.stringify(this.state.consentPolicy));
            void savePolicy({
        ...
        _defineProperty(this, "closeDialog", () => {
            this.closing = true;
            document.body.className = "" + document.body.className.replace(css.bodyPreventScrolling, '');
        ...
        _defineProperty(this, "onCloseTransitionEnd", () => {
            ...
            if (parent) {
                ...
                (_this$state$lastActiv = this.state.lastActiveElement) == null ? void 0 : _this$state$lastActiv.focus();
            }
        ...
        _defineProperty(this, "onToggleChanged", policyKeys => {
            ...
            policyKeys.forEach(policy => newState.consentPolicy[policy] = !this.state.consentPolicy[policy]);
    ...
    render() {
        ...
        configs.forEach(config => {
            ...
            renderComponent(new SectionComponent({
                title: translate(config.titleKey),
                description: translate(config.descriptionKey),
                onToggleChanged: this.onToggleChanged,
                toggleTooltip: config.toggleTooltip ? translate(config.toggleTooltip) : undefined,
