...
export function createResourceLoader({
            ...
            if (options && options.useScriptsInsteadOfEval && isBrowser()) {
                ...
                try {
                    const pending = new Promise((resolve, reject) => {
                        ...
                        script.addEventListener('error', err => reject(err === null || err === void 0 ? void 0 : err.message));
                    });
    ...
    const getModelByBundleID = (id) => {
        if (isServer() && isOriginalRequireFunctionAvailable()) {
