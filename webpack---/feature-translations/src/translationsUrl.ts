...
import type { Translations, TranslatedLanguage } from '@wix/thunderbolt-commons'
...
const languageLoader: { [language in TranslatedLanguage]: () => Promise<{ default: Translations }> } = {
	...
	hr: () =>
		import(
			'@wix/santa-langs/dist/statics/resources/santa-viewer/bundles/_generated/santa_viewer_hr.json' /* webpackChunkName: "santa-langs-hr" */
		),
	lv: () =>
		import(
			'@wix/santa-langs/dist/statics/resources/santa-viewer/bundles/_generated/santa_viewer_lv.json' /* webpackChunkName: "santa-langs-lv" */
		),
	en: () =>
		import(
